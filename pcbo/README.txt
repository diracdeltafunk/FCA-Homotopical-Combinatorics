...
DESCRIPTION
   ...
   Optional arguments
       ...
       -Vlevel,
              ...
              are 0, 1, 2, and 3. The default value is 0. Verbosity  level  0
              just  outputs the total number of intents.  Verbosity  level  1
              produces lists  of intents with no auxiliary output.  Verbosity
              levels 2 and higher write additional information to stderr.
...
AUTHORS
       ...
       Slight modifications by Ben Spitz in June 2025.
